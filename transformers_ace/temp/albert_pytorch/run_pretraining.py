...
from transformers import BertTokenizer, BertConfig, BertForPreTraining, AdamW, \
...
# from .modeling_albert import BertForPreTraining, BertConfig
...
def main():
    ...
    parser.add_argument("--file_num", type=int, default=10,
                        help="Number of dynamic masking to pregenerate (with different masks)")  # TODO: --file-num 이름이 어울리지 않음
